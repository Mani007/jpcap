	...
	class JDTableModel extends AbstractTableModel
	{
		...
		public Object getValueAt(int row,int column){
			...
			Packet packet=(Packet)(captor.getPackets().get(row));
                        ...
                        //System.out.println(packet);//mayank
    ...
    /*public Class getColumnClass(int c) {
		...
		public String getColumnName(int column){
			if(column==0) return "No.";
                        ...
                        String str=((TableView)views.elementAt(column-1)).valueName;//mayank
                        //System.out.print(str);//mayank
                        //System.out.println();
